...
if [ -f packages/rancher-turtles/package.yaml ];  then
    ...
    LOG="DEBUG" ./bin/charts-build-scripts chart-bump --package=rancher-turtles --chart=rancher-turtles --branch=dev-v2.12 --override="${VERSION_OVERRIDE}" --multi-rc="${MULTI_RC}"
